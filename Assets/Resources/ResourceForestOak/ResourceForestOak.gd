...
func _ready():
	...
	expected_settings = {
		Global.TERRAIN.DIRT : [ 0.45, {Global.SUBSTANCE_OAK : [1, 300], Global.SUBSTANCE_MAPLE : [0.1, 30], Global.SUBSTANCE_ELM : [0.1, 30], Global.SUBSTANCE_ROSEWOOD : [0.1, 15]}], 
		Global.TERRAIN.GRASS : [ 0.8, {Global.SUBSTANCE_OAK : [1, 800], Global.SUBSTANCE_MAPLE : [0.1, 50], Global.SUBSTANCE_ELM : [0.1, 50], Global.SUBSTANCE_ROSEWOOD : [0.1, 25]}], 
		Global.TERRAIN.STONE : [0.1, {Global.SUBSTANCE_OAK : [1, 50], Global.SUBSTANCE_MAPLE : [0.05, 5], Global.SUBSTANCE_ELM : [0.05, 5]}]
	}
